...
class UpdateWithExistingLastUpdateIntegrationTest : public IntegrationFixtureBase
{
protected:
    fs::path archivePath;
...
TEST_F(UpdateWithExistingLastUpdateIntegrationTest, ExecuteUpdateWhenPrevManifestExists)
{
    ASSERT_EQ(
