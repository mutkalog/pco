...
class RestartDuringProcessInCommittingStateIntegrationTest : public IntegrationFixtureBase
{
protected:
...
TEST_F(RestartDuringProcessInCommittingStateIntegrationTest, RestartWhileCommittingResumesAndCompletes)
{
