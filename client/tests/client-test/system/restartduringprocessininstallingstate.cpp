...
class RestartDuringProcessInInstallingStateSystemTest : public SystemFixtureBase
{
protected:
...
TEST_F(RestartDuringProcessInInstallingStateSystemTest, RestartWhileInstallingResumesAndCompletes)
{
