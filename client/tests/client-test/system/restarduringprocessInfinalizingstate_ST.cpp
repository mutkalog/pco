...
class RestartDuringProcessInFinalizingStateSystemTest : public SystemFixtureBase
{
protected:
...
TEST_F(RestartDuringProcessInFinalizingStateSystemTest, RestartWhileFinalizingResumesAndCompletes)
{
