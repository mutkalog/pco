...
class RestartDuringProcessInVerifyingStateSystemTest : public SystemFixtureBase
{
protected:
...
TEST_F(RestartDuringProcessInVerifyingStateSystemTest, RestartWhileVerifyingResumesAndCompletes)
{
