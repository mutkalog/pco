...
class RestartDuringProcessInPreparingStateSystemTest : public SystemFixtureBase
{
protected:
...
TEST_F(RestartDuringProcessInPreparingStateSystemTest, RestartWhilePreparingResumesAndCompletes)
{
