...
int ArchiveTools::extract(const char* filename, const char* outdir) {
    struct archive* a;
    struct archive* ext;
...
int ArchiveTools::extract(const uint8_t *buffer, size_t size, const char* outdir) {
...
int ArchiveTools::create_archive_from_paths(const std::vector<std::string>& paths, std::vector<uint8_t>& out)
{
    out.clear();
